...
const InputField = (props) => {
    ...
    return (
        <div className="relative mb-4 group">
            <label htmlFor={props.id || props.name} className="visually-hidden">{props.name}</label>
            {
                props.type === 'message'
            ...
            {meta.touched && meta.error ? (
                <>
                    <p className="text-red text-sm text-right w-full absolute">{meta.error}</p>
                    <img
        ...
        <section id="contact" className="relative bg-grey-dark">
            <div className="container py-20 
                ...
                <div className='lg:w-[40%]'>
                    <h2 className="mb-5 text-heading-m w-full text-center font-clamp
                        lg:text-left"
                    >  
                        Contact
                    </h2>
                ...
                <Formik
                    ...
                    validate= {validate}
                    onSubmit = {async(values,{setSubmitting, handleReset, touched}) => {
                        setIsLoading(true);
                        try {
                    ...
                    {props => (
                        <form onSubmit={props.handleSubmit}>
                            ...
                            <div className="flex justify-end mt-8">
                                <button 
                                    type="submit" 
                                    disabled={!props.values.name || !props.values.email || !props.values.message || isLoading}
                                    ...
                                    relative"
                                >   
                                    <span className='group-disabled:opacity-10'>Send Message</span>
